		...
		<div class="row min-vh-100">
			<div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
				<div class="w-100 py-5 px-md-5 px-xxl-6 position-relative">
					...
					<form class="form-validate" action="signup.do">
						<div class="mb-4">
						...
						<div class="mb-4">
							<input type="checkbox" style="width: 20px; height: 20px;" id="check2" class="normal">&nbsp;<span>이용 약관 동의<strong>(필수)</strong></span>
						...
						<div class="mb-4">
							<input type="checkbox" style="width: 20px; height: 20px;" id="check3" class="normal">&nbsp;<span>개인정보 수집 및 이용<strong>(필수)</strong></span>
						...
						<div class="mb-4">
							<input type="checkbox" style="width: 20px; height: 20px;" id="check4" class="normal">&nbsp;<span>위치 정보 이용 약관<strong>(선택)</strong></span>
