      ...
      <div class="row min-vh-100">
        <div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
          <div class="w-100 py-5 px-md-5 px-xxl-6 position-relative">
            <div class="mb-5"><img class="img-fluid mb-3" src="resources/img/logo-square.svg" alt="..." style="max-width: 4rem;">
              <h3>약관 동의</h3>
            </div>
            <form class="form-validate">
              <div class="mb-4">
                <input type="checkbox" style="width: 20px; height: 20px;" id="check1"><br>
