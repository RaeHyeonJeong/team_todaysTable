...
var Device = (function Device() {
    ...
    // Ratio
    device.pixelRatio = _ssrWindow.window.devicePixelRatio || 1; // Export
																	// object
    return device;
})();
        ...
        if (params.freeModeMomentum) {
            var _ret3 = (function() {
                if (data.velocities.length > 1) {
                    ...
                    // then
                    // released.
                    // There would be no events with distance zero, so the last
					// event is stale.
...
var Swiper = (function(_SwiperClass) {
    ...
    function Swiper() {
        ...
        // Wrapper
        var $wrapperEl = $el.children('.' + swiper.params.wrapperClass); // Extend
																			// Swiper
        Utils.extend(swiper, {
            $el: $el,
            el: el,
            ...
            touchEventsData: {
                ...
                // to
                // match
                formElements: 'input, select, option, textarea, button, video', // Last
																				// click
                // time
...
function isEventSupported() {
    ...
    if (!isSupported && _ssrWindow.document.implementation && _ssrWindow.document.implementation.hasFeature // always
        ...
        &&
        _ssrWindow.document.implementation.hasFeature('', '') !== true) { // This
																			// is
        // the only
        // way to
        // test
...
var Controller = {
    ...
    setTranslate: function setTranslate(_setTranslate, byController) {
        ...
        function setControlledTranslate(c) { // this
            ...
            // the
            // snapGrids
            // x is the Grid of the scrolled scroller and y will be the
			// controlled scroller
